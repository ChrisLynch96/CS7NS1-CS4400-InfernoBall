...
with open('/home/jinchi/scalablecomputing/p5/CS7NS1-CS4400-InfernoBall/Layer5/infernoBallLayer5.json', 'r') as infernoBall:
...
passFile = open('/home/jinchi/scalablecomputing/p5/CS7NS1-CS4400-InfernoBall/Layer5/Broken_Hashes/password.broken', 'r')
...
f = open('infernoBallLayer6.json', 'w+')
f.write(nextLevel)